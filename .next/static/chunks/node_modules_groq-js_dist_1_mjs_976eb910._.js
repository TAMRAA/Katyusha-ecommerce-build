...
class Path {
    ...
    constructor(pattern){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "pattern", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "patternRe", void 0);
...
class StreamValue {
    ...
    constructor(generator){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", "stream");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "generator", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "ticker", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isDone", void 0);
...
function addLeadingZero(num, targetLength) {
    ...
    for(; str.length < targetLength;)str = "0".concat(str);
    return str;
}
class StaticValue {
    isArray() {
...
class DateTime {
    ...
    constructor(date){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "date", void 0);
        this.date = date;
    }
}
...
function matchPatternRegex(text2) {
    return (text2.replace(EDGE_CHARS, "").match(CHARS_WITH_WILDCARD) || []).map((term)=>new RegExp("^".concat(term.slice(0, 1024).replace(/\*/g, ".*"), "$"), "i"));
}
...
let Scope$1 = class Scope {
    ...
    constructor(params, source, value, context, parent){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isHidden", !1);
...
const EXECUTORS = {
    ...
    OpCall (param, scope, execute) {
        let { op, left, right } = param;
        const func = operators[op];
        if (!func) throw new Error("Unknown operator: ".concat(op));
    ...
    async Select (param, scope, execute) {
        let { alternatives, fallback } = param;
    ...
    async InRange (param, scope, execute) {
        let { base, left, right, isInclusive } = param;
    ...
    async Filter (param, scope, execute) {
        let { base, expr } = param;
    ...
    async Projection (param, scope, execute) {
        let { base, expr } = param;
        const baseValue = await execute(base, scope);
    ...
    FuncCall (param, scope, execute) {
        let { func, args } = param;
        return func(args, scope, execute);
    },
    async PipeFuncCall (param, scope, execute) {
        let { func, base, args } = param;
        const baseValue = await execute(base, scope);
        return func(baseValue, args, scope, execute);
    },
    async AccessAttribute (param, scope, execute) {
        let { base, name } = param;
    ...
    async Deref (param, scope, execute) {
        let { base } = param;
    ...
    Group (param, scope, execute) {
        let { base } = param;
        return execute(base, scope);
    },
    async Object (param, scope, execute) {
    ...
    async ArrayCoerce (param, scope, execute) {
        let { base } = param;
        const value = await execute(base, scope);
        return value.isArray() ? value : NULL_VALUE;
    },
    async Map (param, scope, execute) {
        let { base, expr } = param;
        const value = await execute(base, scope);
    ...
    async FlatMap (param, scope, execute) {
        let { base, expr } = param;
        const value = await execute(base, scope);
        return value.isArray() ? new StreamValue(async function*() {
            for await (const elem of value){
...
const dateTime = {};
dateTime.now = async function(_args, scope) {
...
async function anywhere(expr, scope) {
...
diff.changedAny = async (args, scope, execute)=>{
    ...
    const before = await execute(lhs, scope), after = await execute(rhs, scope);
...
class MarkProcessor {
    ...
    process(visitor) {
        ...
        if (!func) throw new Error("Unknown handler: ".concat(mark.name));
    ...
    constructor(string2, marks, parseOptions){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "string", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "marks", void 0);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "parseOptions", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "allowBoost", !1);
...
function parseExpr(str, pos, level) {
    ...
    let failPosition = (trav === null || trav === void 0 ? void 0 : trav.type) === "error" && trav.position;
    return {
        type: "success",
        marks,
        position: pos,
...
function parseGroupOrTuple(str, pos) {
    ...
    switch(pos = skipWS(str, rhs.position), str[pos]){
        ...
        default:
            return {
                type: "error",
                message: 'Unexpected character "'.concat(str[pos], '"'),
                position: pos
            };
    }
    return {
...
class GroqQueryError extends Error {
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "name", "GroqQueryError");
    }
}
const EXPR_BUILDER = {
    group (p) {
    ...
    func_call (p) {
        ...
        const args = [];
        for(; p.getMark().name !== "func_args_end";)argumentShouldBeSelector(namespace, name, args.length) ? args.push(p.process(SELECTOR_BUILDER)) : args.push(p.process(EXPR_BUILDER));
        ...
        if (!funcs) throw new GroqQueryError("Undefined namespace: ".concat(namespace));
        const func = funcs[name];
        if (!func) throw new GroqQueryError("Undefined function: ".concat(name));
        if (func.arity !== void 0 && validateArity(name, func.arity, args.length), func.mode !== void 0 && func.mode !== p.parseOptions.mode) throw new GroqQueryError("Undefined function: ".concat(name));
        return {
            type: "FuncCall",
            func,
            namespace,
    ...
    pipecall (p) {
        ...
        p.shift();
        let namespace = "global";
        if (p.getMark().name === "namespace" && (p.shift(), namespace = p.processString()), namespace !== "global") throw new GroqQueryError("Undefined namespace: ".concat(namespace));
        ...
        if (!func) throw new GroqQueryError("Undefined pipe function: ".concat(name));
    ...
    traverse (p) {
        ...
        for(; p.getMark().name !== "traversal_end";)if (p.getMark().name === "array_postfix") p.shift(), node = {
            ...
            if (!isSelectorNested(selector)) throw new Error("Unexpected result parsing nested selector: ".concat(selector.type));
            node = {
                type: "SelectorNested",
                base: node,
                nested: selector
...
function validateArity(name, arity, count) {
    if (typeof arity == "number") {
        if (count !== arity) throw new GroqQueryError("Incorrect number of arguments to function ".concat(name, "(). Expected ").concat(arity, ", got ").concat(count, "."));
    } else if (arity && !arity(count)) throw new GroqQueryError("Incorrect number of arguments to function ".concat(name, "()."));
}
...
class GroqSyntaxError extends Error {
    constructor(position, detail){
        super("Syntax error in GROQ query at position ".concat(position).concat(detail ? ": " + detail : "")), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "position", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "name", "GroqSyntaxError"), this.position = position;
    }
}
...
function calculateFieldHash(field) {
    switch(field.type){
        ...
        case "number":
        case "boolean":
            return field.value !== void 0 ? "".concat(field.type, "(").concat(field.value, ")") : "".concat(field.type);
        case "null":
        case "unknown":
            return field.type;
        case "array":
            return "".concat(field.type, "(").concat(hashField(field.of), ")");
        case "object":
            {
                const attributes = Object.entries(field.attributes);
                return attributes.sort((param, param1)=>{
                    let [a] = param, [b] = param1;
                    return compare(a, b);
                }), "".concat(field.type, ":(").concat(attributes.map((param)=>{
                    let [key, value] = param;
                    return "".concat(key, ":").concat(hashField(value.value), "(").concat(value.optional ? "optional" : "non-optional", ")");
                }).join(","), "):ref-").concat(field.dereferencesTo, ":").concat(field.rest ? hashField(field.rest) : "no-rest");
            }
        case "union":
            {
                const sorted = [
                ...
                return sorted.sort(typeNodesSorter), "".concat(field.type, "(").concat(sorted.map(hashField).join(","), ")");
            }
        case "inline":
...
function createReferenceTypeNode(name) {
    let inArray = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
    const attributes = {
        _ref: {
...
function mapNode(node, scope, mapper) {
    let mergeUnions = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : (nodes)=>optimizeUnions({
            type: "union",
            of: nodes
        });
    switch(node.type){
...
function isFuncCall(node, name) {
    return node.type === "Group" ? isFuncCall(node.base, name) : node.type === "FuncCall" && "".concat(node.namespace, "::").concat(node.name) === name;
}
function createGeoJson() {
    let type = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "Point";
...
function handleFuncCallNode(node, scope) {
    switch("".concat(node.namespace, ".").concat(node.name)){
        case "array.compact":
            {
                const arg = walk({
                    node: node.args[0],
...
class Scope2 {
    ...
    constructor(value, parent, context){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "parent", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "context", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isHidden", void 0);
        this.value = {
            type: "union",
            of: value
        }, this.parent = parent, this.context = context || (parent === null || parent === void 0 ? void 0 : parent.context) || new Context([]), this.isHidden = !1;
    }
}
...
function handleObjectNode(node, scope) {
    ...
    for (const [idx, attr] of node.attributes.entries()){
        ...
        throw new Error("Unknown object attribute type: ".concat(attr.type));
    }
    ...
    if (guaranteedAttributes.sort((param, param1)=>{
        let [a] = param, [b] = param1;
        return a - b;
    }), conditionalVariants.length === 0) return {
        type: "object",
        attributes: Object.fromEntries(guaranteedAttributes.map((param)=>{
    ...
    for (const [unionIdx, union] of conditionalVariants){
        ...
        for (const node2 of union.of){
            matrix.push({
                type: "object",
                attributes: {
                    ...Object.fromEntries(unionGuaranteedBefore.map((param)=>{
                        let [, name, attribute] = param;
                        return [
                            name,
                            attribute
                    ...
                    ...node2.attributes,
                    ...Object.fromEntries(unionGuaranteedAfter.map((param)=>{
                        let [, name, attribute] = param;
                        return [
                            name,
                            attribute
            ...
            for (const [outerIdx, outerAttributes] of allVariantsAttributes)for (const outer of outerAttributes)for (const [innerIdx, innerAttributes] of allVariantsAttributes)if (outerIdx !== innerIdx) for (const inner of innerAttributes){
                ...
                _before.sort((param, param1)=>{
                    let [a] = param, [b] = param1;
                    return a - b;
                }), _after.sort((param, param1)=>{
                    let [a] = param, [b] = param1;
                    return a - b;
                });
                const before = Object.fromEntries(_before.map((param)=>{
                    let [, name, attribute] = param;
                    return [
                        name,
                        attribute
                    ];
                })), after = Object.fromEntries(_after.map((param)=>{
                    let [, name, attribute] = param;
                    return [
                        name,
                        attribute
    ...
    return mapArray(base, scope, (base2)=>{
        ...
        return mapNode(inner, scope, (inner2)=>inner2.type === "array" ? inner2 : {
            ...
            for (const node2 of nodes){
                ...
                if (node2.type !== "array") throw new Error("Unexpected type: ".concat(node2.type));
...
function handleAccessAttributeBase(base, name, scope) {
    return mapObject(base, scope, (base2)=>{
        ...
        return attribute !== void 0 ? ($debug("accessAttribute.attribute found ".concat(name, " %O"), attribute), attribute.optional ? nullUnion(attribute.value) : attribute.value) : base2.rest ? handleAccessAttributeBase(base2.rest, name, scope) : ($warn('attribute "'.concat(name, '" not found in object')), {
            type: "null"
        });
    });
}
    ...
    switch(typeof node.value){
        ...
        case "object":
            return node.value === null ? {
                ...
                type: "object",
                attributes: Object.fromEntries(Object.entries(node.value).map((param)=>{
                    let [key, value] = param;
                    return [
                        key,
                        {
...
function handleParentNode(param, scope) {
    let { n } = param;
    $trace("handle.parent.currentScope %d %O", n, scope);
    let current = scope;
    for(let i = 0; i < n; i++){
        for(; current === null || current === void 0 ? void 0 : current.isHidden;)current = current.parent;
...
function evaluateComparison(opcall, left, right) {
    if (!(left.value === void 0 || right.value === void 0)) switch(opcall){
        ...
        case ">=":
            return left.value >= right.value;
        default:
            throw new Error("unknown comparison operator ".concat(opcall));
    }
}
function resolveFilter(expr, scope) {
    ...
    return $trace("resolveFilter ".concat(expr.type === "OpCall" ? "".concat(expr.type, "/").concat(expr.op) : expr.type, " %O"), filtered), {
        type: "union",
        of: filtered
    };
}
...
//# sourceMappingURL=node_modules_groq-js_dist_1_mjs_976eb910._.js.map