...
"[project]/node_modules/sanity/lib/_chunks-es/PostMessageSchema.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SchemaIcon = function(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(6), { schemaType, theme: themeContext } = t0, { theme, scheme, tone } = themeContext;
    let t1;
    $[0] === Symbol.for("react.memo_cache_sentinel") ? (t1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$components$2f$dist$2f$styled$2d$components$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ServerStyleSheet"](), $[0] = t1) : t1 = $[0];
    const sheet = t1, Icon = schemaType.icon;
    let t2;
    return $[1] !== Icon || $[2] !== scheme || $[3] !== theme || $[4] !== tone ? (t2 = Icon ? /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$components$2f$dist$2f$styled$2d$components$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StyleSheetManager"], {
    ...
    }) : null, $[1] = Icon, $[2] = scheme, $[3] = theme, $[4] = tone, $[5] = t2) : t2 = $[5], t2;
...
function createReferenceNode(name) {
...
function extractSchema(workspace, theme) {
    ...
    function convertSchemaType(schemaType) {
        var _lastType, _schemaType_type_type, _schemaType_type, _schemaType_type1;
        if (((_lastType = lastType(schemaType)) === null || _lastType === void 0 ? void 0 : _lastType.name) === "document") return createReferenceNode(schemaType.name);
        ...
        if (isStringType(schemaType)) return createStringNodeDefintion(schemaType);
        if (isNumberType(schemaType)) return createNumberNodeDefintion(schemaType);
        const mapped = typesMap.get(((_schemaType_type1 = schemaType.type) === null || _schemaType_type1 === void 0 ? void 0 : _schemaType_type1.name) || "");
        ...
        if (isReferenceType(schemaType)) return createReferenceNodeDefintion(schemaType);
    ...
    function createUnionNodeOptions(schemaType, of) {
        ...
        return options.insertMenu && (opts.insertMenu = {
            ...options.insertMenu,
            views: (_options_insertMenu_views = options.insertMenu.views) === null || _options_insertMenu_views === void 0 ? void 0 : _options_insertMenu_views.map((view)=>view.name === "grid" ? {
                    name: "grid",
                    previewImageUrls: view.previewImageUrl ? of.reduce((acc, param)=>{
                        let { name } = param;
                        var _view_previewImageUrl;
                        const url = (_view_previewImageUrl = view.previewImageUrl) === null || _view_previewImageUrl === void 0 ? void 0 : _view_previewImageUrl.call(view, name);
                        if (!url) return acc;
                        try {
                            new URL(url), acc[name] = url;
                        } catch (e) {
                            acc[name] = new URL(url, "".concat(window.location.origin).concat(basePath ? "".concat(basePath, "/") : "")).toString();
                        }
                        return acc;
                    }, {}) : void 0
                } : view)
...
function getDocumentPathArray(paths) {
    const documentPathMap = paths.reduce((acc, param)=>{
        let { id, path } = param;
        return acc[id] ? acc[id].add(path) : acc[id] = /* @__PURE__ */ new Set([
            path
        ]), acc;
    }, {});
...
function PostMessageSchema(props) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(12), { comlink, perspective } = props, workspace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useWorkspace"])(), theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$ui$2f$dist$2f$_chunks$2d$es$2f$_visual$2d$editing$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRootTheme"])();
    let t0, t1;
    $[0] !== comlink || $[1] !== theme || $[2] !== workspace ? (t0 = ()=>{
        ...
        theme,
        workspace
    ], $[0] = comlink, $[1] = theme, $[2] = workspace, $[3] = t0, $[4] = t1) : (t0 = $[3], t1 = $[4]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t0, t1);
    let t2;
    $[5] !== perspective ? (t2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isReleasePerspective"])(perspective) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["RELEASES_STUDIO_CLIENT_OPTIONS"] : {
    ...
    return $[7] !== client || $[8] !== comlink || $[9] !== perspective ? (t3 = ()=>comlink.on("visual-editing/schema-union-types", async (data)=>{
            const documentPathArray = getDocumentPathArray(data.paths), unionTypes = await Promise.all(documentPathArray.map(async (t5)=>{
                const [id, paths] = t5, arr = Array.from(paths), query = "*[_id == $id][0]{".concat(arr.map(_temp).join(","), "}"), result = await client.fetch(query, {
        ...
        client,
        perspective
    ], $[7] = client, $[8] = comlink, $[9] = perspective, $[10] = t3, $[11] = t4) : (t3 = $[10], t4 = $[11]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t3, t4), null;
}
function _temp2(t0) {
    const { path: path_1, type } = t0;
    return [
        path_1,
        type
    ];
...
function _temp(path, i) {
    return '"'.concat(i, '": ').concat(path, "[0]._type");
}
var PostMessageSchema$1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(PostMessageSchema);
;
 //# sourceMappingURL=PostMessageSchema.mjs.map
}),
]);

//# sourceMappingURL=node_modules_sanity_lib__chunks-es_PostMessageSchema_mjs_e3a88466._.js.map