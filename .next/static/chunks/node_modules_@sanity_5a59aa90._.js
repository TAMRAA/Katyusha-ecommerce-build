...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$util$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/util/node_modules/date-fns/format.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$util$2f$node_modules$2f$date$2d$fns$2f$parse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/util/node_modules/date-fns/parse.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$util$2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/util/node_modules/date-fns/parseISO.js [app-client] (ecmascript)");
;
;
;
...
function getLocalizedDate(date, options) {
    let locale = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "en-US";
    const validLocale = sanitizeLocale(locale);
...
function formatMomentLike(date, formatStr) {
    const escapeSequences = [], escapeToken = "\uE000", processedFormat = formatStr.replace(/\[([^\]]+)\]/g, (_, contents)=>(escapeSequences.push(contents), escapeToken)), year = date.getFullYear(), monthIndex = date.getMonth(), dayOfMonth = date.getDate(), dayOfWeek = date.getDay(), hours = date.getHours(), minutes = date.getMinutes(), seconds = date.getSeconds(), isoWeekNum = getISOWeekNumber(date), isoWeekYear = getISOWeekYear(date), localeWeekYear = getLocaleWeekYear(date), unixMs = date.getTime(), unixSec = Math.floor(unixMs / 1e3), tokens = [
        ...
        {
            key: "Z",
            getValue: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$util$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(date, "xxx")
        },
        {
            key: "ZZ",
            getValue: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$util$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(date, "xx")
        },
        // Time
        {
            key: "LTS",
...
function parse(dateString, dateFormat, timeZone) {
    const dnsFormat = dateFormat ? momentToDateFnsFormat(dateFormat) : void 0, parsed = dnsFormat ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$util$2f$node_modules$2f$date$2d$fns$2f$parse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(dateString, dnsFormat, /* @__PURE__ */ new Date()) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$util$2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(dateString);
...
"[project]/node_modules/@sanity/id-utils/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ts$2d$brand$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/ts-brand/lib/index.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$deburr$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lodash/deburr.js [app-client] (ecmascript)");
;
;
;
;
const VALID_ID = /^[a-z-A-Z0-9._-]+$/, DRAFTS_DIR = "drafts", VERSION_DIR = "versions", PATH_SEPARATOR = ".", DRAFTS_PREFIX = "".concat(DRAFTS_DIR).concat(PATH_SEPARATOR), VERSION_PREFIX = "".concat(VERSION_DIR).concat(PATH_SEPARATOR);
...
function partition(array, predicate) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$partition$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(array, predicate);
}
const DocumentId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ts$2d$brand$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["make"])((id)=>{
    validateAnyId(id);
    const results = [
        validatePublishedId,
        validateDraftId,
    ...
    if (errors.length > 0) throw new AggregateError(errors.map((res)=>res.error), "Invalid Document ID\n - ".concat(errors.map((res)=>res.error.message).join("\n - ")));
    return id;
}), DraftId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ts$2d$brand$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["make"])((id)=>{
    validateAnyId(id), validateDraftId(id);
}), PublishedId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ts$2d$brand$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["make"])((id)=>{
    validateAnyId(id), validatePublishedId(id);
}), VersionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ts$2d$brand$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["make"])((id)=>{
    validateAnyId(id), validateVersionId(id);
});
function validateAnyId(id) {
    if (id.length === 0) throw new Error("Must be a non-empty string");
    if (!VALID_ID.test(id)) throw new Error('Not a valid document ID: "'.concat(id, '" – Must match the ').concat(VALID_ID, " RegExp"));
    return id;
}
function validateDraftId(id) {
    if (!id.startsWith(DRAFTS_PREFIX)) throw new Error('Not a valid draft ID: "'.concat(id, '" – must start with "').concat(DRAFTS_PREFIX, '"'));
    if (id.length === DRAFTS_PREFIX.length) throw new Error('Not a valid draft ID: "'.concat(id, '" – must have at least one character followed by "').concat(DRAFTS_PREFIX, '"'));
    return id;
}
function validateVersionId(id) {
    if (!id.startsWith(VERSION_PREFIX)) throw new Error('Not a valid version ID: "'.concat(id, '" – must start with "').concat(VERSION_PREFIX, '"'));
    if (id.length === VERSION_PREFIX.length) throw new Error('Not a valid version ID: "'.concat(id, '" – must have at least one character followed by "').concat(VERSION_PREFIX, '"'));
    const [, versionName, ...documentId] = id.split(".");
    if (!versionName || !VALID_ID.test(versionName)) throw new Error('Not a valid version ID: "'.concat(id, '" – VERSION must match the ').concat(VALID_ID, " RegExp in versions.[VERSION].id"));
    if (documentId.length === 0) throw new Error('Not a valid version ID: "'.concat(id, '" – missing document ID in versions.bundle.[ID]'));
    if (versionName === "drafts" || versionName === "versions") throw new Error('Not a valid version ID: "'.concat(id, '" – invalid VERSION "').concat(versionName, '" in versions.[VERSION].id'));
    return id;
}
function validatePublishedId(id) {
    if (id.startsWith(DRAFTS_PREFIX) || id.startsWith(VERSION_PREFIX)) throw new Error('Not a valid published ID: "'.concat(id, '" – cannot start with "').concat(DRAFTS_PREFIX, '" or "').concat(VERSION_PREFIX, '"'));
    return id;
}
...
function generateId(input) {
    return input ? makeSafe(input) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__uuid$3e$__["uuid"])();
}
function makeSafe(input) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$deburr$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(input).replace(UNSAFE_CHARS, "").replace(TRAILING, "").replace(LEADING, "").slice(0, GENERATED_IDS_MAX_LENGTH);
}
;
 //# sourceMappingURL=index.js.map
}),
...
function filterUndefinedEntries(value) {
    return Object.fromEntries(Object.entries(value).filter((param)=>{
        let [, entryValue] = param;
        return typeof entryValue < "u";
    }));
}
class StringWrapper {
...
const schemaType = "sanity.previewUrlSecret", schemaIdPrefix = "sanity-preview-url-secret", schemaIdSingleton = "".concat(schemaIdPrefix, ".share-access"), schemaTypeSingleton = "sanity.previewUrlShareAccess", apiVersion = "2025-02-19", urlSearchParamPreviewSecret = "sanity-preview-secret", urlSearchParamPreviewPathname = "sanity-preview-pathname", urlSearchParamPreviewPerspective = "sanity-preview-perspective", urlSearchParamVercelProtectionBypass = "x-vercel-protection-bypass", urlSearchParamVercelSetBypassCookie = "x-vercel-set-bypass-cookie", isDev = ("TURBOPACK compile-time value", "development") === "development", SECRET_TTL = 3600, fetchSecretQuery = /* groq */ '*[_type == "'.concat(schemaType, '" && secret == $secret && dateTime(_updatedAt) > dateTime(now()) - ').concat(SECRET_TTL, "][0]{\n    _id,\n    _updatedAt,\n    secret,\n    studioUrl,\n  }"), fetchSharedAccessQuery = /* groq */ '*[_id == "'.concat(schemaIdSingleton, '" && _type == "').concat(schemaTypeSingleton, '"][0].secret'), fetchSharedAccessSecretQuery = /* groq */ '*[_id == "'.concat(schemaIdSingleton, '" && _type == "').concat(schemaTypeSingleton, '" && secret == $secret][0]{\n  secret,\n  studioUrl,\n}'), deleteExpiredSecretsQuery = /* groq */ '*[_type == "'.concat(schemaType, '" && dateTime(_updatedAt) <= dateTime(now()) - ').concat(SECRET_TTL, "]"), vercelProtectionBypassSchemaType = "sanity.vercelProtectionBypass", vercelProtectionBypassSchemaId = "".concat(schemaIdPrefix, ".vercel-protection-bypass"), fetchVercelProtectionBypassSecret = /* groq */ '*[_id == "'.concat(vercelProtectionBypassSchemaId, '" && _type == "').concat(vercelProtectionBypassSchemaType, '"][0].secret'), tag = "sanity.preview-url-secret", perspectiveCookieName = "sanity-preview-perspective";
;
 //# sourceMappingURL=constants.js.map
}),
]);

//# sourceMappingURL=node_modules_%40sanity_5a59aa90._.js.map