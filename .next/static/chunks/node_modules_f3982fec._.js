...
function applySourceDocuments(result, resultSourceMap, getCachedDocument, updateFn, perspective) {
    var _resultSourceMap_documents_map, _resultSourceMap_documents;
    if (!resultSourceMap) return result;
    const resolveDocument = createSourceDocumentResolver(getCachedDocument, perspective), cachedDocuments = ((_resultSourceMap_documents = resultSourceMap.documents) === null || _resultSourceMap_documents === void 0 ? void 0 : (_resultSourceMap_documents_map = _resultSourceMap_documents.map) === null || _resultSourceMap_documents_map === void 0 ? void 0 : _resultSourceMap_documents_map.call(_resultSourceMap_documents, resolveDocument)) || [];
...
function reducer$1(state, event) {
    switch(event.type){
        ...
        case "welcome":
            return state;
        default:
            throw Error("Unknown event: ".concat(event.type), {
                cause: event
            });
    }
}
...
const mapChangedValue = (changedValue, param)=>{
    let { previousValue } = param;
    if (typeof previousValue == "string") {
        if (typeof changedValue == "number") return "".concat(changedValue);
...
function getQueryCacheKey(perspective, query, params) {
    return "".concat(perspective, ":").concat(query, ":").concat(JSON.stringify(params));
}
function gc(state) {
...
function queryListen(state, param) {
    let { payload } = param;
...
function LiveQueries(props) {
        ...
        if (controller) {
            ...
            return setComlink(nextComlink), nextComlink.onStatus(onLoadersConnection), nextComlink.on("loader/documents", (data)=>{
                ...
                if (data_0.projectId === projectId && data_0.dataset === dataset) {
                    if (typeof data_0.heartbeat == "number" && data_0.heartbeat < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$_chunks$2d$es$2f$presentation$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MIN_LOADER_QUERY_LISTEN_HEARTBEAT_INTERVAL"]) throw new Error("Loader query listen heartbeat interval must be at least ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$_chunks$2d$es$2f$presentation$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MIN_LOADER_QUERY_LISTEN_HEARTBEAT_INTERVAL"], "ms"));
                    var _data_0_heartbeat;
                    liveQueriesDispatch({
                        type: "query-listen",
                        payload: {
                            ...
                            heartbeat: (_data_0_heartbeat = data_0.heartbeat) !== null && _data_0_heartbeat !== void 0 ? _data_0_heartbeat : !1
                        }
                    });
                }
            }), nextComlink.start();
    ...
    $[12] !== activePerspective || $[13] !== comlink || $[14] !== dataset || $[15] !== projectId ? (t4 = ()=>{
        ...
        projectId,
        dataset
    ], $[12] = activePerspective, $[13] = comlink, $[14] = dataset, $[15] = projectId, $[16] = t4, $[17] = t5) : (t4 = $[16], t5 = $[17]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t4, t5);
    ...
    return $[20] !== client || $[21] !== comlink || $[22] !== dataset || $[23] !== liveDocument || $[24] !== liveEvents || $[25] !== projectId || $[26] !== t6 ? (t7 = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: t6.map((t8)=>{
            ...
            }, "".concat(liveEvents.resets, ":").concat(key));
        })
...
function QuerySubscriptionComponent(props) {
    ...
    $[0] !== dataset || $[1] !== projectId ? (t0 = (comlink_0, perspective_0, query_0, params_0, result_0, resultSourceMap_0, tags_0)=>{
        comlink_0 === null || comlink_0 === void 0 ? void 0 : comlink_0.post("loader/query-change", {
            projectId,
            dataset,
...
function useQuerySubscription(props) {
    ...
    if ($[2] !== liveEventsMessages || $[3] !== skipEventIds || $[4] !== syncTags) {
        ...
        let t32;
        $[8] !== syncTags ? (t32 = (msg_1)=>msg_1.tags.some((tag)=>syncTags === null || syncTags === void 0 ? void 0 : syncTags.includes(tag)), $[8] = syncTags, $[9] = t32) : t32 = $[9], t1 = recentLiveEvents.findLast(t32), $[2] = liveEventsMessages, $[3] = skipEventIds, $[4] = syncTags, $[5] = t1;
    } else t1 = $[5];
    const lastLiveEventId = t1 === null || t1 === void 0 ? void 0 : t1.id, [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    $[10] !== client || $[11] !== lastLiveEventId || $[12] !== params || $[13] !== perspective || $[14] !== query ? (t2 = ()=>{
        ...
        return client.fetch(query, params, {
            ...
            (typeof err != "object" || (err === null || err === void 0 ? void 0 : err.name) !== "AbortError") && setError(err);
        }), ()=>{
            controller.abort();
        };
    }, t3 = [
...
//# sourceMappingURL=node_modules_f3982fec._.js.map