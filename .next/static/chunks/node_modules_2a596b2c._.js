...
var se = {
    ...
    var M, h;
    if (a) {
        let E = x("Your device appears to be offline", o), D = void 0, y = f.MEDIA_ERR_NETWORK, k = new f(E, y, !1, D);
        return k.errorCategory = t, k.muxCode = b.NETWORK_OFFLINE, k.data = e, k;
    }
    ...
    if (p && !m) {
        ...
        return y.errorCategory = t, y.muxCode = b.NETWORK_TOKEN_MALFORMED, y.data = e, y;
    }
    if (c >= 500) {
        let E = new f("", u, n != null ? n : !0);
        return E.errorCategory = t, E.muxCode = b.NETWORK_UNKNOWN_ERROR, E;
    }
    if (c === 403) if (m) {
        if (Te(m, d)) {
            let E = {
            ...
            return k.errorCategory = t, k.muxCode = b.NETWORK_TOKEN_EXPIRED, k.data = e, k;
        }
        if (ye(m, T)) {
            ...
            return y.errorCategory = t, y.muxCode = b.NETWORK_TOKEN_SUB_MISMATCH, y.data = e, y;
        }
        if (me(m, l)) {
            ...
            return y.errorCategory = t, y.muxCode = b.NETWORK_TOKEN_AUD_MISSING, y.data = e, y;
        }
        if (Ee(m, l)) {
            let E = x("The {tokenNamePrefix}-token is formatted with incorrect information.", o).format({
                tokenNamePrefix: s
            ...
            return y.errorCategory = t, y.muxCode = b.NETWORK_TOKEN_AUD_MISMATCH, y.data = e, y;
        }
    } else {
        let E = x("Authorization error trying to access this {category} URL. If this is a signed URL, you might need to provide a {tokenNamePrefix}-token.", o).format({
            ...
            playbackId: T
        }), y = new f(E, u, n != null ? n : !0, D);
        return y.errorCategory = t, y.muxCode = b.NETWORK_TOKEN_MISSING, y.data = e, y;
    }
    if (c === 412) {
        let E = x("This playback-id may belong to a live stream that is not currently active or an asset that is not ready.", o), D = x("Specified playback ID: {playbackId}", o).format({
            playbackId: T
        }), y = new f(E, u, n != null ? n : !0, D);
        return y.errorCategory = t, y.muxCode = b.NETWORK_NOT_READY, y.streamType = r.streamType === _.LIVE ? "live" : r.streamType === _.ON_DEMAND ? "on-demand" : "unknown", y.data = e, y;
    }
    if (c === 404) {
        let E = x("This URL or playback-id does not exist. You may have used an Asset ID or an ID from a different resource.", o), D = x("Specified playback ID: {playbackId}", o).format({
            playbackId: T
        }), y = new f(E, u, n != null ? n : !0, D);
        return y.errorCategory = t, y.muxCode = b.NETWORK_NOT_FOUND, y.data = e, y;
    }
    if (c === 400) {
        let E = x("The URL or playback-id was invalid. You may have used an invalid value as a playback-id."), D = x("Specified playback ID: {playbackId}", o).format({
            playbackId: T
        }), y = new f(E, u, n != null ? n : !0, D);
        return y.errorCategory = t, y.muxCode = b.NETWORK_INVALID_URL, y.data = e, y;
    }
    let R = new f("", u, n != null ? n : !0);
    return R.errorCategory = t, R.muxCode = b.NETWORK_UNKNOWN_ERROR, R.data = e, R;
};
...
}, Oe, Ue, Dt = (Ue = (Oe = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Oe.userAgent) != null ? Ue : "", He, Ve, Ke, Ct = (Ke = (Ve = (He = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : He.userAgentData) == null ? void 0 : Ve.platform) != null ? Ke : "", vt = Dt.toLowerCase().includes("android") || [
    "x11",
    "android"
...
var St = (e, t)=>{
    ...
    if (u && !s && Fe) {
        let p = {
            ...
            xhrSetup: (M, h)=>{
                ...
                let D = ((k = (y = E.searchParams.get("CMCD")) == null ? void 0 : y.split(",")) != null ? k : []).filter((pe)=>pe.startsWith("sid") || pe.startsWith("cid")).join(",");
                E.searchParams.set("CMCD", D), M.open("GET", E);
            },
        ...
        return R.on(g.Events.MANIFEST_PARSED, async function(M, h) {
            var D, y;
            let E = (D = h.sessionData) == null ? void 0 : D["com.apple.hls.chapters"];
        ...
        try {
            ...
            if (!t.mediaKeys) {
                let u = await navigator.requestMediaKeySystemAccess("com.apple.fps", [
                    ...
                    l.errorCategory = C.DRM, l.muxCode = b.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM, N(t, l);
                });
                if (!u) return;
                ...
                try {
                    ...
                    await s.setServerCertificate(p).catch(()=>{
                        ...
                        return T.errorCategory = C.DRM, T.muxCode = b.ENCRYPTED_UPDATE_SERVER_CERT_FAILED, Promise.reject(T);
                    });
                } catch (p) {
                    N(t, p);
                    return;
            ...
            i.addEventListener("keystatuseschange", ()=>{
                i.keyStatuses.forEach((u)=>{
                    ...
                    if (u === "internal-error") {
                        ...
                        s = new f(p, f.MEDIA_ERR_ENCRYPTED, !0), s.errorCategory = C.DRM, s.muxCode = b.ENCRYPTED_CDM_ERROR;
                        ...
                        s = new f(p, f.MEDIA_ERR_ENCRYPTED, !1), s.errorCategory = C.DRM, s.muxCode = b.ENCRYPTED_OUTPUT_RESTRICTED;
                    }
                    s && N(t, s);
                });
            });
            let c = await Promise.all([
                i.generateRequest(o, a).catch(()=>{
                    ...
                    s.errorCategory = C.DRM, s.muxCode = b.ENCRYPTED_GENERATE_REQUEST_FAILED, N(t, s);
                }),
                new Promise((u)=>{
            ...
            await i.update(d).catch(()=>{
                ...
                return s.errorCategory = C.DRM, s.muxCode = b.ENCRYPTED_UPDATE_LICENSE_FAILED, Promise.reject(s);
            });
        } catch (o) {
            N(t, o);
            return;
    ...
    let n = qe(e, t), { src: o, customDomain: a = I } = e, i = ()=>{
        t.ended || e.disablePseudoEnded || !At(t, r) || (Je(t, r) ? t.currentTime = t.buffered.end(t.buffered.length - 1) : t.dispatchEvent(new Event("ended")));
    }, c, d, u = ()=>{
        let l = Be(t), T, m;
    ...
    if (v(t, "durationchange", u), t && n) {
        ...
        if (typeof o == "string") {
            ...
            (s = e.tokens) != null && s.drm ? Vt(e, t) : v(t, "encrypted", ()=>{
                ...
                M.errorCategory = C.DRM, M.muxCode = b.ENCRYPTED_MISSING_TOKEN, N(t, M);
            }, {
                once: !0
        ...
        bt(T.details, t, r), u(), we(t) === _.LIVE && !Number.isFinite(t.duration) && (r.on(g.Events.LEVEL_UPDATED, u), v(t, "durationchange", ()=>{
            Number.isFinite(t.duration) && r.off(g.Events.LEVELS_UPDATED, u);
        }));
    }), r.on(g.Events.ERROR, (l, T)=>{
        var R, M;
        let m = Yt(T, e);
        if (m.muxCode === b.NETWORK_NOT_READY) {
            let E = (R = P.get(t)) != null ? R : {}, D = (M = E.retryCount) != null ? M : 0;
            if (D < 6) {
                let y = D === 0 ? 5e3 : 6e4, k = new f("Retrying in ".concat(y / 1e3, " seconds..."), m.code, m.fatal);
                Object.assign(k, m), N(t, k), setTimeout(()=>{
                    E.retryCount = D + 1, T.details === "manifestLoadError" && T.url && r.loadSource(T.url);
                }, y);
                return;
            } else {
                E.retryCount = 0;
    ...
    }), t.addEventListener("error", ce), v(t, "waiting", i), be(e, r), De(t, r), r.attachMedia(t)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function ze(e) {
    var n;
...
var Yt = (e, t)=>{
    ...
    if (i === f.MEDIA_ERR_NETWORK && e.response) {
        ...
        a = new f(s, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_MISSING_TOKEN;
        ...
        a = new f(s, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM;
        ...
        a = new f(s, f.MEDIA_ERR_ENCRYPTED, !0), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_GENERATE_REQUEST_FAILED;
        ...
        a = new f(s, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_UPDATE_LICENSE_FAILED;
        ...
        a = new f(s, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_UPDATE_SERVER_CERT_FAILED;
        ...
        a = new f(s, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_CDM_ERROR;
        ...
        a = new f(s, f.MEDIA_ERR_ENCRYPTED, !1), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_OUTPUT_RESTRICTED;
    } else a = new f(e.error.message, f.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = C.DRM, a.muxCode = b.ENCRYPTED_ERROR;
...
function CustomMediaMixin(superclass, param) {
    ...
    return _isInit = /*#__PURE__*/ new WeakMap(), _nativeEl = /*#__PURE__*/ new WeakMap(), _childMap = /*#__PURE__*/ new WeakMap(), _childObserver = /*#__PURE__*/ new WeakMap(), _init = /*#__PURE__*/ new WeakSet(), _syncMediaChildren = /*#__PURE__*/ new WeakSet(), _syncMediaChildAttribute = /*#__PURE__*/ new WeakSet(), _enableDefaultTrack = /*#__PURE__*/ new WeakSet(), _upgradeProperty = /*#__PURE__*/ new WeakSet(), _forwardAttribute = /*#__PURE__*/ new WeakSet(), _CustomMedia = class CustomMedia extends superclass {
        ...
        init() {
            ...
            this.shadowRoot.addEventListener("slotchange", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_class_private_method_get$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, _syncMediaChildren, syncMediaChildren).call(this));
...
var n = (s, a, t)=>(N(s, a, "read from private field"), t ? t.call(s) : a.get(s)), u = (s, a, t)=>a.has(s) ? C("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(s) : a.set(s, t), o = (s, a, t, i)=>(N(s, a, "write to private field"), i ? i.call(s, t) : a.set(s, t), t), I = (s, a, t)=>(N(s, a, "access private method"), t);
;
var B = ()=>{
    try {
        return "0.27.0";
...
var e = {
    ...
    TYPE: "type",
    LOGO: "logo"
}, at = Object.values(e), v = P(), x = "mux-video", l, f, b, A, c, T, _, p, O, g, m, y, K = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"] {
    static get NAME() {
        return x;
    }
    static get VERSION() {
    ...
    static getLogoHTML(t) {
        return !t || t === "false" ? "" : t === "default" ? D : '<img part="logo" src="'.concat(t, '" />');
    }
    static getTemplateHTML() {
        let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        var i;
        return "\n      ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"].getTemplateHTML(t), '\n      <style>\n        :host {\n          position: relative;\n        }\n        slot[name="logo"] {\n          display: flex;\n          justify-content: end;\n          position: absolute;\n          top: 1rem;\n          right: 1rem;\n          opacity: 0;\n          transition: opacity 0.25s ease-in-out;\n          z-index: 1;\n        }\n        slot[name="logo"]:has([part="logo"]) {\n          opacity: 1;\n        }\n        slot[name="logo"] [part="logo"] {\n          width: 5rem;\n          pointer-events: none;\n          user-select: none;\n        }\n      </style>\n      <slot name="logo">\n        ').concat(this.getLogoHTML((i = t[e.LOGO]) != null ? i : ""), "\n      </slot>\n    ");
    }
    get preferCmcd() {
        var t;
    ...
    get playbackToken() {
        ...
        if (this.hasAttribute(e.PLAYBACK_ID)) {
            let [, h] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toPlaybackIdParts"])((i = this.playbackId) != null ? i : "");
            return (r = new URLSearchParams(h).get("token")) != null ? r : void 0;
        }
    ...
    get liveEdgeStart() {
        ...
        if (this.hasAttribute(e.LIVE_EDGE_OFFSET)) {
            let { liveEdgeOffset: r } = this, d = (t = this.nativeEl.seekable.end(0)) != null ? t : 0, h = (i = this.nativeEl.seekable.start(0)) != null ? i : 0;
            return Math.max(h, d - r);
        }
    ...
    attributeChangedCallback(t, i, r) {
        ...
        switch(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"].observedAttributes.includes(t) && ![
            ...
            case "src":
                {
                    let E = !!i, S = !!r;
                    !E && S ? I(this, m, y).call(this) : E && !S ? this.unload() : E && S && (this.unload(), I(this, m, y).call(this));
                    break;
                }
            case "autoplay":
                if (r === i) break;
                (h = n(this, l)) == null || h.setAutoplay(this.autoplay);
                break;
            case "preload":
                if (r === i) break;
            ...
            case e.METADATA_URL:
                r && fetch(r).then((E)=>E.json()).then((E)=>this.metadata = E).catch(()=>console.error("Unable to load or parse metadata JSON from metadata-url ".concat(r, "!")));
                break;
            case e.STREAM_TYPE:
    ...
    connectedCallback() {
        var t;
        (t = super.connectedCallback) == null || t.call(this), this.nativeEl && this.src && !n(this, l) && I(this, m, y).call(this);
    }
    ...
    constructor(){
        ...
        u(this, O);
        u(this, g, "");
        o(this, b, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generatePlayerInitTime"])()), this.nativeEl.addEventListener("muxmetadata", (t)=>{
            var d;
...
l = new WeakMap, f = new WeakMap, b = new WeakMap, A = new WeakMap, c = new WeakMap, T = new WeakMap, _ = new WeakMap, p = new WeakMap, O = new WeakMap, g = new WeakMap, m = new WeakSet, y = async function() {
...
function removeVideoTrack(track) {
    ...
    const trackList = (_getPrivate_media = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media) === null || _getPrivate_media === void 0 ? void 0 : _getPrivate_media.videoTracks;
    if (!trackList) return;
    const trackSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).trackSet;
...
function removeAudioTrack(track) {
    var _getPrivate_media;
    const trackList = (_getPrivate_media = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media) === null || _getPrivate_media === void 0 ? void 0 : _getPrivate_media.audioTracks;
    if (!trackList) return;
    const trackSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).trackSet;
    trackSet.delete(track);
    queueMicrotask(()=>{
...
function VideoPlayer(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(5), { customDomain, playbackId, tokens } = t0;
    let t1;
...
//# sourceMappingURL=node_modules_2a596b2c._.js.map