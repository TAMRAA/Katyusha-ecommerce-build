...
useEffect(()=>{
    fetch("/api/sale/black-friday") // no trailing slash
    .then((res)=>{
        if (!res.ok) throw new Error("Network response was not ok");
        return res.json();
    }).then((data)=>{
        if (data?.isActive) setSale(data);
    }).catch((err)=>console.error("Error fetching Black Friday sale:", err));
}, []);
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a90ec75b._.js.map