...
var St = (e, t)=>{
    ...
    if (v(t, "durationchange", u), t && n) {
        ...
        if (m.muxCode === b.NETWORK_NOT_READY) {
            ...
            if (D < 6) {
                let y = D === 0 ? 5e3 : 6e4, k = new f(`Retrying in ${y / 1e3} seconds...`, m.code, m.fatal);
...
var e = {
    ...
    TYPE: "type",
    LOGO: "logo"
}, at = Object.values(e), v = P(), x = "mux-video", l, f, b, A, c, T, _, p, O, g, m, y, K = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CustomVideoElement"] {
    constructor(){
        super();
        u(this, m);
        u(this, l);
        ...
        u(this, O);
        u(this, g, "");
        o(this, b, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generatePlayerInitTime"])()), this.nativeEl.addEventListener("muxmetadata", (t)=>{
            var d;
    ...
    get playbackToken() {
        ...
        if (this.hasAttribute(e.PLAYBACK_ID)) {
            let [, h] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toPlaybackIdParts"])((i = this.playbackId) != null ? i : "");
    ...
    attributeChangedCallback(t, i, r) {
        ...
        switch(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CustomVideoElement"].observedAttributes.includes(t) && ![
            ...
            case e.METADATA_URL:
                r && fetch(r).then((E)=>E.json()).then((E)=>this.metadata = E).catch(()=>console.error(`Unable to load or parse metadata JSON from metadata-url ${r}!`));
                break;
            case e.STREAM_TYPE:
...
function VideoPlayer(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(5), { customDomain, playbackId, tokens } = t0;
    let t1;
...
//# sourceMappingURL=node_modules_c791c99b._.js.map