module.exports = [
"[project]/node_modules/sanity/lib/_chunks-es/PostMessageSchema.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SchemaIcon = function(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(6), { schemaType, theme: themeContext } = t0, { theme, scheme, tone } = themeContext;
    let t1;
    $[0] === Symbol.for("react.memo_cache_sentinel") ? (t1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$components$2f$dist$2f$styled$2d$components$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ServerStyleSheet"](), $[0] = t1) : t1 = $[0];
...
function extractSchema(workspace, theme) {
    ...
    function convertSchemaType(schemaType) {
        if (lastType(schemaType)?.name === "document") return createReferenceNode(schemaType.name);
    ...
    function createUnionNodeOptions(schemaType, of) {
        ...
        return options.insertMenu && (opts.insertMenu = {
            ...
            views: options.insertMenu.views?.map((view)=>view.name === "grid" ? {
                    name: "grid",
                    previewImageUrls: view.previewImageUrl ? of.reduce((acc, { name })=>{
...
function getDocumentPathArray(paths) {
    const documentPathMap = paths.reduce((acc, { id, path })=>(acc[id] ? acc[id].add(path) : acc[id] = /* @__PURE__ */ new Set([
            path
        ]), acc), {});
    return Object.entries(documentPathMap);
}
function PostMessageSchema(props) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(12), { comlink, perspective } = props, workspace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useWorkspace"])(), theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$ui$2f$dist$2f$_chunks$2d$es$2f$_visual$2d$editing$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRootTheme"])();
    let t0, t1;
    $[0] !== comlink || $[1] !== theme || $[2] !== workspace ? (t0 = ()=>{
        ...
        theme,
        workspace
    ], $[0] = comlink, $[1] = theme, $[2] = workspace, $[3] = t0, $[4] = t1) : (t0 = $[3], t1 = $[4]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(t0, t1);
    let t2;
    $[5] !== perspective ? (t2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isReleasePerspective"])(perspective) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["RELEASES_STUDIO_CLIENT_OPTIONS"] : {
    ...
    return $[7] !== client || $[8] !== comlink || $[9] !== perspective ? (t3 = ()=>comlink.on("visual-editing/schema-union-types", async (data)=>{
        ...
        client,
        perspective
    ], $[7] = client, $[8] = comlink, $[9] = perspective, $[10] = t3, $[11] = t4) : (t3 = $[10], t4 = $[11]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(t3, t4), null;
}
function _temp2(t0) {
...
var PostMessageSchema$1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["memo"])(PostMessageSchema);
;
 //# sourceMappingURL=PostMessageSchema.mjs.map
}),
];

//# sourceMappingURL=node_modules_sanity_lib__chunks-es_PostMessageSchema_mjs_55b6feec._.js.map