module.exports = [
"[project]/node_modules/@sanity/schema/lib/_chunks-es/Rule.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$cloneDeep$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lodash/cloneDeep.js [app-ssr] (ecmascript)");
;
;
;
;
...
}, DEFAULT_MAX_FIELD_DEPTH = 5, stringFieldsSymbols = {}, getStringFieldSymbol = (maxDepth)=>(stringFieldsSymbols[maxDepth] || (stringFieldsSymbols[maxDepth] = Symbol(`__cachedStringFields_${maxDepth}`)), stringFieldsSymbols[maxDepth]), isReference = (type)=>type.type && type.type.name === "reference", portableTextFields = [
    "style",
    "list"
...
function createFieldsGroups(typeDef, fields) {
    ...
    }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$flatMap$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(groupsByName).filter(// All fields group is added by default in structure.
...
const ReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS.map((fieldDef)=>{
            ...
            })), lazyGetter(parsed, "fieldsets", ()=>createFieldsets(subTypeDef, parsed.fields)), lazyGetter(parsed, "to", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(subTypeDef.to).map((toType)=>createMemberType(toType))), lazyGetter(parsed, "title", ()=>subTypeDef.title || buildTitle(parsed)), lazyGetter(parsed, OWN_PROPS_NAME, ()=>({
                ...subTypeDef,
                fields: parsed.fields,
                fieldsets: parsed.fieldsets,
                to: parsed.to,
...
const FIELD_REF = Symbol("FIELD_REF"), ruleConstraintTypes = [
    ...
    clone() {
        ...
        return rule._type = this._type, rule._message = this._message, rule._required = this._required, rule._rules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$cloneDeep$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(this._rules), rule._level = this._level, rule._fieldRules = this._fieldRules, rule._typeDef = this._typeDef, rule;
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$Rule$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/schema/lib/_chunks-es/Rule.mjs [app-ssr] (ecmascript)");
...
function convertUnknown(val, seen = /* @__PURE__ */ new Set(), maxDepth = MAX_DEPTH_UKNOWN) {
    ...
    if (seen.add(val), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(val)) {
...
function maybeStringOrJSX(val) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(val) && "$$typeof" in val && "type" in val && "props" in val) {
        const { type, props } = val, strType = typeof type == "function" ? type.name : type;
        return typeof strType != "string" ? void 0 : {
            __type: "jsx",
            type: strType,
...
function maybeValidations(obj) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(obj) || !("type" in obj)) return;
    const impliedRules = [];
    switch("options" in obj && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(obj.options) && "list" in obj.options && Array.isArray(obj.options.list) && impliedRules.push({
        type: "enum",
    ...
    for (const rule of rules){
        ...
        const rulesToAdd = impliedRules.filter((ir)=>!validation.rules.some((r)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isEqual$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(r, ir)));
        rulesToAdd.length > 0 && validation.rules.unshift(...rulesToAdd), !validations.some((v)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isEqual$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(v, validation)) && validations.push(validation);
    }
...
function extractValueFromListOption(option, typeDef) {
    return typeDef.jsonType === "object" && hasValueField(typeDef) ? option : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(option) && "value" in option && option.value ? option.value : option;
}
function maybeValidation(val) {
    if (val) {
        if (isIRuleFunction(val)) try {
            const result = val(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$Rule$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Rule"]());
        ...
        if (isIRule(val)) {
            ...
            for (const spec of val._rules || []){
                ...
                convertedRule !== void 0 && (rules.some((r)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isEqual$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(r, convertedRule)) || rules.push(convertedRule));
            }
...
function isIRule(val) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(val) && "_rules" in val;
}
function maybeValidationMessage(val) {
    if (typeof val == "string") return val;
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(val) || Array.isArray(val)) return;
    const objectMessage = {};
...
function convertRuleSpec(spec, optional) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(spec) || !("flag" in spec)) return;
    ...
    switch(spec.flag){
        ...
        case "regex":
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(constraint) && "pattern" in constraint) {
        ...
        case "uri":
            {
                const allowRelative = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(constraint) && "options" in constraint && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(constraint.options) && "allowRelative" in constraint.options ? maybeBoolean(constraint.options.allowRelative) : void 0;
                return {
                    type: "uri",
...
function convertConstraintValue(constraint) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(constraint) && "type" in constraint && "path" in constraint && constraint.type && constraint.path ? {
        type: "fieldReference",
...
const builtinSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$Rule$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Schema"].compile({
    name: "studio",
    types: builtinTypes
});
function createSchemaFromManifestTypes(schemaDef) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$Rule$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Schema"].compile({
        name: schemaDef.name,
...
function coerceType(obj) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(obj)) return;
    const typ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$cloneDeep$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(obj);
    return traverse(typ), typ;
}
function traverse(obj) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(obj)) {
...
function coerceValidation(val) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(val) || !("validation" in val)) return;
    const manifestValidation = Array.isArray(val.validation) ? val.validation : [
        val.validation
    ];
    val.validation = manifestValidation.map((group)=>{
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(group)) return (baseRule)=>{
            let rule = baseRule;
...
function coerceConstraintRule(val) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(val)) return Array.isArray(val) ? val.map(coerceConstraintRule).filter(Boolean) : (baseRule)=>{
        let rule = baseRule;
...
function applyRuleSpec(rule, ruleSpec) {
    ...
    switch(flag){
        ...
        case "valid":
            ...
            break;
        case "regex":
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(constraint) && "pattern" in constraint && (typeof constraint.pattern == "string" || constraint.pattern instanceof RegExp)) {
                const options = {};
            ...
            break;
        case "uri":
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isObject$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(constraint) && "options" in constraint) return rule.uri(constraint.options);
            break;
        case "assetRequired":
...
"[project]/node_modules/@sanity/schema/lib/index.mjs [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
;
;
const Schema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$Rule$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Schema"];
;
 //# sourceMappingURL=index.mjs.map
}),
];

//# sourceMappingURL=node_modules_%40sanity_schema_lib_6d4acfeb._.js.map