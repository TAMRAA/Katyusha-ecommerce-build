module.exports = [
"[project]/.next-internal/server/app/(store)/webhook/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/sanity/lib/backendClient.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const backendClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$index$2e$browser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])({
...
"[project]/app/(store)/webhook/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40c3f795a9219f50f6f4a2e2cf85b55728c7996397":"POST"},"",""] */ __turbopack_context__.s([
    "POST",
    ()=>POST
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$sanity$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/sanity/lib/backendClient.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    let event;
    try {
        event = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].webhooks.constructEvent(body, sig, webhookSecret);
    } catch (err) {
...
async function createOrderInSanity(session) {
    ...
    const lineItemsWithProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].checkout.sessions.listLineItems(id, {
        expand: [
            "data.price.product"
        ]
    });
    ...
    const order = await __TURBOPACK__imported__module__$5b$project$5d2f$sanity$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["backendClient"].create({
        _type: "order",
        orderNumber,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(POST, "40c3f795a9219f50f6f4a2e2cf85b55728c7996397", null);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__bb17b590._.js.map